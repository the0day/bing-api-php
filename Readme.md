...
Open Source Project for Reverse Engineering Bing AI without Cookie Usage
...
If you think there is an actual problem in this library, please [open](https://github.com/fakellgit/bing-api-php/issues/new) an issue if there isn't one already created.
